...
dir = '/Volumes/Scratch/hybrid/RT/RT_bhs_2/'
...
;   b1(0,0,0,0) = 120.
   ...
   im2 = image(uparr,/current,rgb_table=33,layout=[3,2,4],/buffer)
   ...
   ct = colorbar(target = im2,title='$u_{pz}$ (km/s)',orientation=1,textpos=1)
   ...
   im4 = image(mixarr,/current,rgb_table=33,layout=[3,2,3],/buffer)
